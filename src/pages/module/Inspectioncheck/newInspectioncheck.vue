  ...
  <div class="newInspectioncheck">
    ...
    <div class="content">
      <el-form :model="form" ref="form" align='center'>
        ...
        <div class="m_b10"><h3 align='left'>诊疗项目内容</h3></div>

        <div class="demo-form-inline">
          <el-form-item>
              <el-row class="preContentul">
                <el-col :span="2">序号</el-col>
                <el-col :span="6">诊疗项目名称</el-col>
          ...
          <el-form-item class="prescriptionInputs" v-for="(item, index) in form.data.item_list" :key='index'>
            ...
            <!--药品名称  -->
            <el-col :span="6">
              <el-form-item :rules="{ required: true, message: '请输入项目名称', trigger: 'blur,change' }">
                  <el-autocomplete popper-class="my-autocomplete"  v-model="item.name"  size="small" :fetch-suggestions="querySearchAsync" placeholder="请输入名称" @select="inspectionSelect($event, index)" :trigger-on-focus="false" valueKey='name'>
            ...
            <!--数量  -->
            <el-col :span="3">
              <el-form-item :rules="{ required: true, message: '请输入数量', trigger: 'blur,change' }">
                <el-input v-model="item.total" class="inlineBlock" @keyup.native="numberInp('total')" @change="calculateAll(index)" size="small" ></el-input>
              </el-form-item>
            </el-col>
            <!-- 数量单位 -->
            <el-col :span="3">
              <el-form-item :rules="{ required: true, message: '请输入单位', trigger: 'blur,change' }">
            ...
            <el-col :span="4">
              ...
              <span>￥ {{ item.showprice | PriceFilter }}</span>
              </el-form-item>
            </el-col>
            <!--金额  -->
            <el-col :span="4">
              <el-form-item align='center'>
              <span>￥ {{ item.total_showprice | PriceFilter }}</span>
              </el-form-item>
            </el-col>
